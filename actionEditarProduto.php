...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $idProduto = testar_entrada($_POST["idProduto"]); //Recebe o ID do produto a ser editado
        ...
        if ($_FILES['fotoProduto']['size'] != 0){
            ...
            $fotoProduto = $_POST["fotoAtual"]; //Mantém a foto atual caso não haja atualização 
            $erroUpload = false;
        }
        ...
        if(!$erroPreenchimento && !$erroUpload){
            ...
            //Criar uma QUERY responsável por realizar a edição dos dados no BD
            $editarProduto= "
            UPDATE Produtos
            SET
        ...
        ";
            ...
            //Se não conseguir inserir dados do Produto na base de dados, emite alerta danger
                ...
                echo "<div class='alert alert-danger text-center'>
                            Erro ao tentar editar dados <strong>Produto</strong> na base de dados!
                        </div>";
            }
        }
    }
        ...
        header("location:formEditarProduto.php");
    }
